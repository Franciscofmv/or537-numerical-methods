...
H=tank_height(T); % calculate tank height, line integral
a={-1,-1,0};
b={1,1,H};
% evaluate mass with gsimp
M=gsimp(f,a,b,n) % generalized simpson
...
function [h] = tank_height(T) % height of liquid in the tank, calculate volume
A=4;
h=integral(@qfunc,0,T)/A; % using matlab built in function
return
